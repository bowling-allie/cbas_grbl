...
#define cpu_map_h
  ...
  // allie added these
  // Define liquid dispensing output pins.
  #define LIQUID_1_DDR   DDRC
  #define LIQUID_1_PORT  PORTC
  #define LIQUID_1_BIT   6 // MEGA2560 Digital Pin 31
  #define LIQUID_2_DDR   DDRC
  #define LIQUID_2_PORT  PORTC
  #define LIQUID_2_BIT   4 // MEGA2560 Digital Pin 33
  #define LIQUID_3_DDR   DDRC
  #define LIQUID_3_PORT  PORTC
  #define LIQUID_3_BIT   2 // MEGA2560 Digital Pin 35
  #define LIQUID_4_DDR   DDRC
  #define LIQUID_4_PORT  PORTC
  #define LIQUID_4_BIT   0 // MEGA2560 Digital Pin 37
