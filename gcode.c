...
uint8_t gc_execute_line(char *line)
{
      ...
      case 'M':
        ...
        switch(int_value) {
          ...
          case 7: case 8: case 9:
            ...
            break;
          case 10: case 11: case 12: case 13: case 14: case 21: case 22: case 23: case 24:
            dword_bit = MODAL_GROUP_M10;
            switch(int_value) {
              case 10: gc_block.modal.liquid = LIQUID_DISABLE; break;
              case 11: gc_block.modal.liquid = LIQUID_1_ENABLE; break;
              case 12: gc_block.modal.liquid = LIQUID_2_ENABLE; break;
              case 13: gc_block.modal.liquid = LIQUID_3_ENABLE; break;
              case 14: gc_block.modal.liquid = LIQUID_4_ENABLE; break;
              case 21: gc_block.modal.liquid = LIQUID_1_DISABLE; break;
              case 22: gc_block.modal.liquid = LIQUID_2_DISABLE; break;
              case 23: gc_block.modal.liquid = LIQUID_3_DISABLE; break;
              case 24: gc_block.modal.liquid = LIQUID_4_DISABLE; break;
            }
            break;
  ...
  */
  ...
  // todo: finish
  // [8.5. Liquid control ]:
  if (gc_state.modal.liquid != gc_block.modal.liquid) {
    // NOTE: Liquid M-codes are modal. Only one command per line is allowed. But, multiple states
    // can exist at the same time, while liquid disable clears all states.
    liquid_sync(gc_block.modal.liquid);
    if (gc_block.modal.liquid == LIQUID_DISABLE) { gc_state.modal.liquid = LIQUID_DISABLE; }
    else { gc_state.modal.liquid |= gc_block.modal.liquid; }
  }
  ...
  if (gc_state.modal.program_flow) {
    ...
    if (gc_state.modal.program_flow == PROGRAM_FLOW_PAUSED) {
      ...
      gc_state.modal.liquid = LIQUID_DISABLE;
      #ifdef ENABLE_PARKING_OVERRIDE_CONTROL
