...
#define MODAL_GROUP_M10 15 // [M10, M11, M12, M13, M14] Liquid control
...
// Modal Group M10: Liquid control
#define LIQUID_DISABLE   0      // M10 (Default: Must be zero)
#define LIQUID_1_ENABLE  bit(0) // M11
#define LIQUID_2_ENABLE  bit(1) // M12
#define LIQUID_3_ENABLE  bit(2) // M13
#define LIQUID_4_ENABLE  bit(3) // M14
#define LIQUID_1_DISABLE bit(8) // M21
#define LIQUID_2_DISABLE bit(9) // M22
#define LIQUID_3_DISABLE bit(10) // M23
#define LIQUID_4_DISABLE bit(11) // M24
...
typedef struct {
  ...
  uint16_t liquid;          // {M10,M11,M12,M13,M14}
