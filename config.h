...
// allie added these
// Inverts the selected liquid pin from low-disabled/high-enabled to low-enabled/high-disabled. Useful
// for some pre-built electronic boards.
// #define INVERT_LIQUID_1_PIN // Default disabled. Uncomment to enable.
// #define INVERT_LIQUID_2_PIN // Default disabled. Uncomment to enable.
// #define INVERT_LIQUID_3_PIN // Default disabled. Uncomment to enable.
// #define INVERT_LIQUID_4_PIN // Default disabled. Uncomment to enable.
